    ...
    <div class="flex justify-center gap-10 items-center w-full">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex gap-4">
                ...
                <img class="w-13 h-8" src="{{ asset('storage/images/logo-seputar-info-id.jpg') }} " alt="Seputar Info Id">
                <img class="w-13 h-8" src="{{ asset('storage/images/logo-lomba-sma.png') }}" alt="Lomba SMA">
                <img class="w-13 h-8" src="{{ asset('storage/images/logo-pojok-event.jpeg') }}" alt="Pojok Event">
                <img class="w-13 h-8" src="{{ asset('storage/images/logo-partner-event.png') }}" alt="Partner Event">
            </div>
        </div>
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex gap-4">
                ...
                <img class="w-13 h-8" src="{{ asset('storage/images/logo-bank-jateng.jpg') }} " alt="Bank Jateng">
