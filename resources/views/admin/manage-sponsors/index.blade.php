<x-app-layout>
                ...
                <div class="mb-6">
                    <nav class="text-sm text-gray-500">
                        <ol class="list-reset flex items-center space-x-2">
                            ...
                            <li class="text-purple-700 font-semibold">Kelola Sponsor</li>
                        </ol>
                        <h1 class="text-3xl font-bold text-gray-800 mt-2">Kelola Sponsor</h1>
                    </nav>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-yellow-600">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center">
                            ...
                            <h2 class="text-2xl font-bold text-gray-800">Data Sponsor</h2>
                        </div>
                        <button
                            class="text-white bg-yellow-500 hover:bg-yellow-600 font-medium rounded-lg text-sm px-5 py-2.5 transition duration-150"
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left">
                            <thead class="text-xs text-gray-900 uppercase bg-yellow-50 font-extrabold">
                                <tr>
                            ...
                            <tbody>
                                @forelse ($sponsors as $sponsor)
                                    <tr class="bg-white border-b hover:bg-yellow-50 transition duration-150">
                                        ...
                                        <td class="px-6 py-4">
                                            <img src="{{ asset('storage/images/sponsor/' . $sponsor->logo) }}"
                                                alt="{{ $sponsor->name }}" class="w-16 h-16 object-contain">
                                        </td>
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-2">
                                                <button type="button"
                                                    data-modal-target="edit-modal-{{ $sponsor->id }}"
                                                ...
                                                <button data-modal-target="delete-modal-{{ $sponsor->id }}"
                                    ...
                                    @include('admin.manage-sponsors.edit-modal', [
                                        'sponsor' => $sponsor,
                                    ])
                                    @include('admin.manage-sponsors.delete-modal', [
                                        'sponsor' => $sponsor,
                                    ])
                                @empty
                                    <tr>
                                        <td colspan="5" class="px-6 py-8 text-center text-gray-500">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <p class="text-lg font-semibold">Tidak ada data sponsor</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
    ...
    <!-- Include Add Modal -->
    @include('admin.manage-sponsors.add-modal')
