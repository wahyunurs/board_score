...
<div id="edit-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow light:bg-gray-700">
            ...
            <!-- Modal body -->
            <form method="POST" action="" id="edit-team-form" enctype="multipart/form-data" class="p-4 md:p-5">
                @csrf
                @method('PUT')
...
<!-- Call javascript edit-team-modal.js -->
<script src="{{ asset('js/edit-team-modal.js') }}"></script>
