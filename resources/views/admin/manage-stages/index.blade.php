                ...
                <div class="mb-6">
                    <nav class="text-sm text-gray-500">
                        <ol class="list-reset flex items-center space-x-2">
                            ...
                            <li class="text-purple-700 font-semibold">Kelola Stages</li>
                        </ol>
                        <h1 class="text-3xl font-bold text-gray-800 mt-2">Kelola Stages</h1>
                    </nav>
                </div>
                            ...
                            <tbody>
                                @forelse ($stages as $stage)
                                    <tr class="bg-white border-b hover:bg-green-50 transition duration-150">
                                        ...
                                        <td class="px-6 py-4">
                                            <button type="button" data-modal-target="edit-modal-{{ $stage->id }}"
                                    ...
                                    <!-- Include edit modal -->
                                    @include('admin.manage-stages.edit-modal', ['stage' => $stage])
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-6 py-8 text-center text-gray-500">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <p class="text-lg font-semibold">Tidak ada data stages</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
